...
class Params:
    ...
    evaluate = False
    resume = ''
    rootdir = '/data/pjkrveil/'														# path to train images
    train_file = '/data/pjkrveil/annotation/train2017.json'							# path to train file
    val_file = '/data/pjkrveil/annotation/val2017.json'								# path to val file

    # uncomment if want to evaluate the test set and save a submission file
    evaluate = True
    save_preds = True
    resume = '/home/pjkrveil/inception_v3_normal/model_best.pth.tar'				# path to trained model
    val_file = '/data/pjkrveil/annotation/test2017.json'							# path to test file
    rootdir = '/data/pjkrveil/test2017/'											# path to test images
    op_file_name = '/home/pjkrveil/inception_v3_normal/result/test_result.csv'		# submission filename
